...
.get() method in python is most commonly used with dictionaries. It's a safe way to access
a key without causing an error if the key doesn't exist
...
print(person.get('city',  'N/A'))      # N/A (default value)
